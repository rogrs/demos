...
import br.com.rogrs.demo.service.LocationService;
import br.com.rogrs.demo.domain.Location;
import br.com.rogrs.demo.repository.LocationRepository;
import br.com.rogrs.demo.repository.search.LocationSearchRepository;
import br.com.rogrs.demo.service.dto.LocationDTO;
import br.com.rogrs.demo.service.mapper.LocationMapper;
...
public class LocationServiceImpl implements LocationService{
    ...
    /**
     *  get all the locations where Departament is null.
     *  @return the list of entities
     */
    @Transactional(readOnly = true) 
    public List<LocationDTO> findAllWhereDepartamentIsNull() {
        log.debug("Request to get all locations where Departament is null");
        return StreamSupport
            .stream(locationRepository.findAll().spliterator(), false)
            .filter(location -> location.getDepartament() == null)
            .map(locationMapper::toDto)
            .collect(Collectors.toCollection(LinkedList::new));
    }
