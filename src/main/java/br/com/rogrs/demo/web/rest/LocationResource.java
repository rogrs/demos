...
public class LocationResource {
    ...
    public List<LocationDTO> getAllLocations(@RequestParam(required = false) String filter) {
        if ("departament-is-null".equals(filter)) {
            log.debug("REST request to get all Locations where departament is null");
            return locationService.findAllWhereDepartamentIsNull();
        }
